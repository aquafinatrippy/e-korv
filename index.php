        ...
        <div class="area4" id="area4">
          ...
          <hr>
            ...
            <section class="mb-4 contactv2">
                ...
                <div class="row">
                    <!--Grid column-->
                    <div class="kontaktAla d-flex justify-content-around">
                      <div class="col-md-9 mb-md-0 mb-5">
                          <form id="contact-form" name="contact-form" action="mail.php" method="POST">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <div class="md-form mb-0">
                                          <label for="name" class="">Sinu nimi...</label>
                                  ...
                                  <div class="col-md-6">
                                      <div class="md-form mb-0">
                                          <label for="email" class="">Sinu email...</label>
                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                      <div class="md-form mb-0">
                                          <label for="subject" class="">Teema...</label>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-12">
                                      <div class="md-form">
                                          <label for="message">Sinu sõnum...</label>
                          ...
                          <div class="text-center text-md-left">
                            <a class="btn btn-primary" onclick="validateForm()">Saada</a>
                          </div>
